...
@Composable
fun Header(notesViewModel: NotesViewModel, navigationController: NavHostController) {
    TopAppBar(
...
@Composable
private fun ShowMenu(notesViewModel: NotesViewModel) {
...
fun AllNotes(navigationController: NavHostController, homeViewModel: HomeViewModel) {
    val notesListState: List<NoteEntity> by homeViewModel.allNotes.collectAsState(initial = emptyList())
...
fun Folders(navigationController: NavHostController, homeViewModel: HomeViewModel) {
    val foldersList: List<FolderEntity> by homeViewModel.allFolders.collectAsState(initial = emptyList())
